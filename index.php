...
$maison1 = new Maison("France", "Anor", 59186, 3, 7, true, 1, true);
...
$maison2 = new Maison("France", "Fourmies", 59610, 5, 10, true, 2, false);
...
$appart = new Appartement("France", "Wignehies", 59212, 4, 8, true);
...
echo $appart->setGarage(false)."<br>";
